            ...
            <tbody>
                @foreach ($productsList as $product)
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        <td class="py-3 whitespace-nowrap">
                            <div class="flex items-center gap-3">
                                <div class="h-[50px] w-[50px] overflow-hidden rounded-md">
                                    <img src="{{ asset('storage/' . $product->product->primaryImage->image) }}"
                                        alt="{{ $product['name'] }}" />
                                </div>
                                <div>
                        ...
                        <td class="py-3 whitespace-nowrap">
                            <p class="text-gray-500 text-theme-sm dark:text-gray-400">{{ $product->product->price }}</p>
                        </td>
                        <td class="py-3 whitespace-nowrap">
                            <span class="{{ $getStatusClasses($product->order->status) }}">
